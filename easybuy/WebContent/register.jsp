...
<jsp:include page="header.jsp"/>
	...
	<div class="shadow">
		...
		<div class="box">
			<h1>欢迎注册易买网<c:if test="${regstatus ==1}">（信息填写错误！请重新填写）</c:if></h1>
			...
			<form id="regForm" method="post" action="registservlet" onsubmit="return checkForm(this);">
				<table>
					...
					<tr>
						...
						<td>男<input style="width:20px;" class="text" type="radio" value="男" name="sex" onfocus="FocusItem(this)" onblur="CheckItem(this);" />
							女<input style="width:20px;" class="text" type="radio" name="sex" value="女" onfocus="FocusItem(this)" onblur="CheckItem(this);" />
						<span></span></td>
					</tr>
					<tr>
